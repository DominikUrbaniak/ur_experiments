        ...
        #        self.get_logger().warn(f'Timeout triggered at {experiment_timeout}s!')
            ...
            if self.timeout or self.terminated:
                ...
                if perform_logging and not self.terminated:
                    ...
                    output_config_filename = output_dir + str(experiment_time) + "_" + str(sensing_rate) + "_" + "_config_parameters.csv"
                    output_log_filename = output_dir + str(experiment_time) + "_" + str(sensing_rate) + "_logging.csv"
                    ...
                    experiment_time = int(time.time())
                    output_config_filename = output_dir + str(experiment_time) + "_" + str(sensing_rate) + "_" + qos_profile + "_config_parameters_failed.csv"
                    output_log_filename = output_dir + str(experiment_time) + "_" + str(sensing_rate) + "_logging_failed.csv"
